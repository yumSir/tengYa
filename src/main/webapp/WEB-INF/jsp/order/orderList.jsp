            ...
            <div id="page-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">销售订单</h3>
                    </div>
                    <div id="demo-custom-toolbar" class="table-toolbar-left">
                        <button id="demo-dt-addrow-btn" class="btn btn-primary" onclick="orderAdd()"><i class="demo-pli-plus"></i> 增加</button>
                        <button id="demo-dt-delete-btn" class="btn btn-danger" onclick="orderDel(this)"><i class="demo-pli-cross"></i> 删除</button>
                    </div>
                    <div class="panel-body">
                        <table id="demo-dt-delete" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            <c:forEach  items="${orderList}"  var="item"  varStatus="userStatus">
                                <tr>
                                    <td><fmt:formatDate value="${item.orderDate}" type="date"/></td>
