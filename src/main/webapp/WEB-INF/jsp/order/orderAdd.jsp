                ...
                <div class="row">
                    <div class="col-lg">
                        <div class="panel">
                            ...
                            <!--Input Size-->
                            <!--===================================================-->
                            <form class="form-horizontal" action="/order/orderSave" method="post">
                                <div class="panel-body" ng-app="myApp" ng-controller="myCtrl">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">日期</label>
                                        <div class="input-group date">
                                            <input type="date" name="orderDate" class="form-control" placeholder="yyyy-mm-dd" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">单据编号</label>
                                        <div class="col-sm-4">
                                            <input type="text" oninput="preSql(this)" name="orderCode" class="form-control" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" oninput="preSql(this)" name="productName" value="" required="required" hidden>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">产品长代码</label>
                                        <div class="col-sm-4">
                                            <input type="text" oninput="preSql(this)" value="{{ productCode }}" name="productCode" class="form-control input-lg" readonly  required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
