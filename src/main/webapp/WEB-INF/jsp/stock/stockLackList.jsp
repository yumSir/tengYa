                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <table id="demo-dt-delete" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            <c:forEach  items="${stockLackList}"  var="item"  varStatus="userStatus">
                                <tr>
                            ...
                            <ul id="mainnav-menu" class="list-group">
                                ...
                                <li class="active-sub">
                                    ...
                                    <ul class="collapse in">
                                        ...
                                        <li class="active-link"><a href="/stock/selectStockLackList">缺料显示</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
